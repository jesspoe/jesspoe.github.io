    ...
    <div className="about-wrapper">
      ...
      <div className="about-me">
        ...
        <div className="bio-text">
          ...
          <p>I enjoy solve logic puzzles for fun and pride myself on being a dynamic and detail-oriented Web Developer with a knack for conceptualizing and delivering elegant, user-friendly solutions effectively and efficiently.  </p>
